...
This repo is a collection of **Free APIs** APIs for developers. Feel free to **Star** and **Fork**. Any comments, suggestions? [Let us know](https://github.com/nero002/Public-Apis/issues). we love PRs :), please follow the [awesome](https://github.com/nero002/Public-Apis/) list.
